...
const ServiceMant = () => {
  return (
    <div className="mt-16">
      <div className="relative bg-[url(/servicio-mantenimiento.jpeg)] h-[35rem] bg-center bg-no-repeat bg-cover">
        <div className="absolute w-full h-full flex items-center justify-center bg-black/35">
          <h2 className="text-white font-bold text-[clamp(1.8rem,5vw,3rem)] text-center uppercase">Mantenimiento integral de Maquinarias</h2>
        </div>
      </div>
      <article className="w-[85%] max-w-7xl mx-auto py-40 mt-8 m-auto flex flex-col gap-8 justify-center">
        ...
        <ul className="text-lg md:text-xl font-light text-gray-700 pl-8">
