        ...
        <form action="" className="pt-6 flex flex-col gap-3 sm:gap-5">
            ...
            <div className="flex flex-col gap-4 md:flex-row">
                <div className="flex flex-col w-full">
                    ...
                    <input type="number" placeholder="Tu numero" className="border-[1px] text-[16px] text-gray-600 px-2 py-1 rounded-sm border-[#254168]/25"/>
                </div>
                <div className="flex flex-col w-full">
                    <label htmlFor="" className="text-[#254168] sm:text-[18px]">Ruc :</label>
                    <input type="number" placeholder="Numero de ruc" className="border-[1px] text-[16px] text-gray-600 px-2 py-1 rounded-sm border-[#254168]/25"/>
                </div>
            </div>
            <div className="flex flex-col gap-2">
            ...
            <button onClick={btnForm} className="cursor-pointer flex justify-center items-center gap-2 text-[#254168] bg-[#f9cb21] self-center w-full h-10 rounded-sm mt-2"> 
                <MdOutlineNearMe />
                <p>Enviar mensaje</p>
            </button>
        </form>
