...
const Header = () => {
  ...
  return (
    <header className="w-full shadow-md absolute top-0 z-50 bg-white backdrop-blur-md">
      <nav className="p-2">
        <div className="flex w-full justify-between items-center p-2 gap-4 sm:w-[98%] md:w-[95%] xl:w-[85%] 2xl:w-[70%] mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Mobile Menu Icon */}
            <div className="md:hidden hover:bg-gray-100 p-2 rounded-xl cursor-pointer" onClick={handleIsShowNav} 
