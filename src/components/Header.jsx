...
const Header = () => {
  ...
  return (
    <header className="w-full shadow-md fixed top-0 z-50 bg-white backdrop-blur-md">
      <nav className="p-2">
        <div className="flex justify-between items-center p-2 gap-4 sm:w-[98%] md:w-[95%] xl:w-[85%] 2xl:w-[70%] mx-auto">
          {/* Logo */}
          ...
          <div className="flex items-center gap-4">
            ...
            <ul className="hidden md:flex gap-6" data-aos="fade-down" data-aos-delay="200">
              <li className="p-3 text-[#254168] hover:bg-gray-100 cursor-pointer rounded-lg text-sm sm:text-base transition-colors duration-300">
                Inicio
              </li>
              <li className="p-3 text-[#254168] hover:bg-gray-100 cursor-pointer rounded-lg text-sm sm:text-base transition-colors duration-300">
                Nosotros
            ...
            {/* Mobile Menu Icon */}
            <div className="md:hidden hover:bg-gray-100 p-2 rounded-xl cursor-pointer" onClick={handleIsShowNav} data-aos="fade-left" data-aos-delay="400">
        ...
        >
          <div
            className={`absolute top-0 left-0 w-64 bg-white h-full shadow-lg transition-transform duration-300 ${isShowNav ? "translate-x-0" : "-translate-x-full"}`}
          ...
          >
            ...
            <ul className="flex flex-col gap-4 p-4">
              <li className="p-3 text-[#254168] hover:bg-gray-100 cursor-pointer rounded-lg text-base transition-colors duration-300">
                Inicio
              </li>
              <li className="p-3 text-[#254168] hover:bg-gray-100 cursor-pointer rounded-lg text-base transition-colors duration-300">
                Nosotros
